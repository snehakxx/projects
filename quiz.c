...
int main()//main program starts
     {
     int countr,r,r1,count,i,n;//variable declare
     float score;
     char choice;
     char name[20];
     mainhome:
    ...
    system("cls");
     ...
     switch(r1)
		...
		if (toupper(getch())=='D')
			{
		       ...
		       {
		           printf("\n\nWrong!!! The correct answer is D.nepal");
		           getch();
		       break;
		       }
		...
		printf("\n\nA.islamabad\t\tB.karachi\n\nC.lahore\t\tD.kathmandu");
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.islamabad");
		       getch();
		       break;}

        case 3:
		printf("\n\n\nwhen did maoist armed revolution in nepal startn?");
		printf("\n\nA.1954\t\tB.1899\n\nC.1996\t\tD.1998");
		if (toupper(getch())=='C')
			{printf("\n\nCorrect!!!");count++;
			getch();
		...
		{
			   printf("\n\nWrong!!! The correct answer is C.1996");
		       getch();
		       break;
			   }
        ...
        case 6:
		printf("\n\n\nwhen was deerwalk institute of technology established?");
		printf("\n\nA.A 2022\t\tB. 1999\n\nC.2015\t\tD.2010");
		if (toupper(getch())=='D' )
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is D.2010");
		       getch();
		       break;}}
		       }
	...
	goto mainhome;
     ...
     test:
     system("cls");
     printf("\n\n\t*** CONGRATULATION %s you are eligible to play the Game ***",name);
